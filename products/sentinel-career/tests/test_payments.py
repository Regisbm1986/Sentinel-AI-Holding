...
from backend.payments.plans import get_plans, get_plan
from backend.payments.checkout import create_checkout, confirm_payment
from backend.payments.subscriptions import create_subscription, cancel_subscription, renew_subscription, get_subscription
from backend.payments.models import Plan, Payment, Subscription
from backend.payments.exceptions import PaymentError, SubscriptionError, PlanNotFound, PaymentFailed
...
def test_plan_errors():
    ...
    with pytest.raises(PaymentError):
        from backend.payments.validators import validate_plan_id
